...
For both registrations, the RMSE (in meters) and transformation matrices were recorded after registration was completed.

\subsection{Cloud to Cloud Distance}

The setting was initially set to not have a max distance, which showed distances of up to 12 relative units away. This was done to investigate the approximate distances 
